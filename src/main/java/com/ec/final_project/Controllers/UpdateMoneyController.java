...
public class UpdateMoneyController {
    ...
    public static void check_and_update() {
        taikhoan_tietkiemService saving_AccService = new taikhoan_tietkiemService() {
            @Override
...
//        Sql2o s = new Sql2o("jdbc:mysql://localhost:3306/digbank", "root", "root");
//
